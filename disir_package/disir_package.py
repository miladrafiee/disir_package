...
def main_disir(subunit_interactions_path, gene_names_all_path, cell_type_labels_path, scRNA_array_path, outdir,
    ...
    scRNA_array = pd.read_csv(scRNA_array_path, header = 0, index_col = 0).to_numpy()
    cell_type_labels_raw = pd.read_csv(cell_type_labels_path, header = None, index_col = None)
    ...
    for LR_set in LR_info:
        ...
        plot_heatmaps(heatmap_dict, unique_cell_type_labels, outdir=f'{outdir}/{relation}/heatmaps/')
